...
//     $this->db->select('appointments.appointment_id, user.name AS patient_name, user.lastname AS patient_lastname, doctor.specialization, appointments.hospital, appointments.appointment_date, appointments.reason, appointments.status');
//     $this->db->from('appointments');
//     $this->db->join('user', 'user.user_id = appointments.patient_id', 'left');
//     $this->db->join('doctor', 'doctor.user_id = appointments.doctor_id', 'left');
//     $query = $this->db->get();
...
//         return $query->result();
//     } else {
//         return array(); // Return an empty array if no appointments found
//     }
// }
